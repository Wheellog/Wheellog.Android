...
public class AppConfig extends AppConfigBase {
    ...
    public void switchSettingOwner(String keyString, Boolean fromControl) {
        ...
        switch (keyString) {
            ...
            case "alarm_1_speed": setAlarm1Speed(getAlarm1Speed(fromControlOptional), fromControlReverseOptional); return;
            case "alarm_1_battery": setAlarm1Battery(getAlarm1Battery(fromControlOptional), fromControlReverseOptional); return;
            case "alarm_2_speed": setAlarm2Speed(getAlarm2Speed(fromControlOptional), fromControlReverseOptional); return;
            case "alarm_2_battery": setAlarm2Battery(getAlarm2Battery(fromControlOptional), fromControlReverseOptional); return;
            case "alarm_3_speed": setAlarm3Speed(getAlarm3Speed(fromControlOptional), fromControlReverseOptional); return;
            case "alarm_3_battery": setAlarm3Battery(getAlarm3Battery(fromControlOptional), fromControlReverseOptional); return;
            case "alarm_current": setAlarmCurrent(getAlarmCurrent(fromControlOptional), fromControlReverseOptional); return;
            case "alarm_temperature": setAlarmTemperature(getAlarmTemperature(fromControlOptional), fromControlReverseOptional); return;
            case "altered_alarms": setAlteredAlarms(getAlteredAlarms(fromControlOptional), fromControlReverseOptional); return;
            case "rotation_speed": setRotationSpeed(getRotationSpeed(fromControlOptional), fromControlReverseOptional); return;
            case "rotation_voltage": setRotationVoltage(getRotationVoltage(fromControlOptional), fromControlReverseOptional); return;
            case "power_factor": setPowerFactor(getPowerFactor(fromControlOptional), fromControlReverseOptional); return;
            case "alarm_factor1": setAlarmFactor1(getAlarmFactor1(fromControlOptional), fromControlReverseOptional); return;
            case "alarm_factor2": setAlarmFactor2(getAlarmFactor2(fromControlOptional), fromControlReverseOptional); return;
            case "alarm_factor3": setAlarmFactor3(getAlarmFactor3(fromControlOptional), fromControlReverseOptional); return;
            case "warning_speed": setWarningSpeed(getWarningSpeed(fromControlOptional), fromControlReverseOptional); return;
            case "warning_pwm": setWarningPwm(getWarningPwm(fromControlOptional), fromControlReverseOptional); return;
            case "warning_speed_period": setWarningSpeedPeriod(getWarningSpeedPeriod(fromControlOptional), fromControlReverseOptional); return;
            case "use_short_pwm": setUseShortPwm(getUseShortPwm(fromControlOptional), fromControlReverseOptional); return;
            case "light_enabled": setLightEnabled(getLightEnabled(fromControlOptional), fromControlReverseOptional); return;
            case "led_enabled": setLedEnabled(getLedEnabled(fromControlOptional), fromControlReverseOptional); return;
            case "handle_button_disabled": setHandleButtonDisabled(getHandleButtonDisabled(fromControlOptional), fromControlReverseOptional); return;
            case "wheel_max_speed": setWheelMaxSpeed(getWheelMaxSpeed(fromControlOptional), fromControlReverseOptional); return;
            case "speaker_volume": setSpeakerVolume(getSpeakerVolume(fromControlOptional), fromControlReverseOptional); return;
            case "pedals_adjustment": setPedalsAdjustment(getPedalsAdjustment(fromControlOptional), fromControlReverseOptional); return;
            case "pedals_mode": setPedalsMode(getPedalsMode(fromControlOptional), fromControlReverseOptional); return;
            case "light_mode": setLightMode(getLightMode(fromControlOptional), fromControlReverseOptional); return;
            case "strobe_mode": setStrobeMode(getStrobeMode(fromControlOptional), fromControlReverseOptional); return;
            case "led_mode": setLedMode(getLedMode(fromControlOptional), fromControlReverseOptional); return;
            case "alarm_mode": setAlarmMode(getAlarmMode(fromControlOptional), fromControlReverseOptional); return;
            case "gotway_voltage": setGotwayVoltage(getGotwayVoltage(fromControlOptional), fromControlReverseOptional); return;
            case "gotway_negative": setGotwayNegative(getGotwayNegative(fromControlOptional), fromControlReverseOptional); return;
            case "wheel_ks_alarm3": setWheelKsAlarm1(getWheelKsAlarm1(fromControlOptional), fromControlReverseOptional); return;
            case "wheel_ks_alarm2": setWheelKsAlarm2(getWheelKsAlarm2(fromControlOptional), fromControlReverseOptional); return;
            case "wheel_ks_alarm1": setWheelKsAlarm3(getWheelKsAlarm3(fromControlOptional), fromControlReverseOptional); return;
            case "use_better_percents": setUseBetterPercents(getUseBetterPercents(fromControlOptional), fromControlReverseOptional); return;
            case "fixed_percents": setFixedPercents(getFixedPercents(fromControlOptional), fromControlReverseOptional); return;
            case "tiltback_voltage": setTiltbackVoltage(getTiltbackVoltage(fromControlOptional), fromControlReverseOptional); return;
            case "current_on_dial": setCurrentOnDial(getCurrentOnDial(fromControlOptional), fromControlReverseOptional); return;
            case "battery_capacity": setBatteryCapacity(getBatteryCapacity(fromControlOptional), fromControlReverseOptional); return;
            case "charging_power": setChargingPower(getChargingPower(fromControlOptional), fromControlReverseOptional); return;
            case "connect_beep": setConnectBeep(getConnectBeep(fromControlOptional), fromControlReverseOptional); return;
            ...
            // Add here all settings, which are changed through controls, which are common for all wheels
            // Remember to add them to the "controlSettings" array.
            case "show_unknown_devices": setShowUnknownDevices(getShowUnknownDevices(fromControlOptional), fromControlReverseOptional); return;
            case "auto_log": setAutoLog(getAutoLog(fromControlOptional), fromControlReverseOptional); return;
            case "auto_upload_ec": setAutoUploadEc(getAutoUploadEc(fromControlOptional), fromControlReverseOptional); return;
            case "ec_token": setEcToken(getEcToken(fromControlOptional), fromControlReverseOptional); return;
            case "ec_user_id": setEcUserId(getEcUserId(fromControlOptional), fromControlReverseOptional); return;
            case "auto_upload": setAutoUpload(getAutoUpload(fromControlOptional), fromControlReverseOptional); return;
            case "log_location_data": setLogLocationData(getLogLocationData(fromControlOptional), fromControlReverseOptional); return;
            case "use_gps": setUseGps(getUseGps(fromControlOptional), fromControlReverseOptional); return;
            case "use_mph": setUseMph(getUseMph(fromControlOptional), fromControlReverseOptional); return;
            case "use_eng": setUseEng(getUseEng(fromControlOptional), fromControlReverseOptional); return;
            case "use_pip_mode": setUsePipMode(getUsePipMode(fromControlOptional), fromControlReverseOptional); return;
