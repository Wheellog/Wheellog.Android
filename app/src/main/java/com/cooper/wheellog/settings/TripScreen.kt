...
fun tripScreen( ) {
    Column(
        ...
        clickablePref(
            name = R.string.reset_max_values_title,
            desc = R.string.reset_max_values_description,
            showArrowIcon = false,
        ) {
        ...
        clickablePref(
            name = R.string.reset_lowest_battery_title,
            showArrowIcon = false,
        ) {
        ...
        clickablePref(
            name = R.string.reset_user_distance_title,
            showArrowIcon = false,
        ) {
