...
public class MainActivity extends AppCompatActivity implements IDataListener {
    ...
    public void setSecondPageValue(int resId)
    {
        secondPageValues.put(resId, "");
    }

    public void updateSecondPageValue(int resId, String value)
    {
    ...
    private void configureDisplay(WHEEL_TYPE wheelType) {
        ...
        switch (wheelType) {
            case KINGSONG:
                setSecondPageValue(R.string.speed);
                setSecondPageValue(R.string.top_speed);
                setSecondPageValue(R.string.average_speed);
                setSecondPageValue(R.string.average_riding_speed);
                setSecondPageValue(R.string.battery);
                setSecondPageValue(R.string.output);
                setSecondPageValue(R.string.cpuload);
                setSecondPageValue(R.string.temperature);
                setSecondPageValue(R.string.temperature2);
                setSecondPageValue(R.string.ride_time);
                setSecondPageValue(R.string.riding_time);
                setSecondPageValue(R.string.distance);
                setSecondPageValue(R.string.wheel_distance);
                setSecondPageValue(R.string.user_distance);
                setSecondPageValue(R.string.total_distance);
                setSecondPageValue(R.string.voltage);
                setSecondPageValue(R.string.voltage_sag);
                setSecondPageValue(R.string.current);
                setSecondPageValue(R.string.power);
                setSecondPageValue(R.string.fan_status);
                setSecondPageValue(R.string.charging);
                setSecondPageValue(R.string.mode);
                setSecondPageValue(R.string.name);
                setSecondPageValue(R.string.model);
                setSecondPageValue(R.string.version);
                setSecondPageValue(R.string.serial_number);
                break;
            ...
            case INMOTION:
                ...
                setSecondPageValue(R.string.temperature);
                setSecondPageValue(R.string.temperature2);
                setSecondPageValue(R.string.angle);
                setSecondPageValue(R.string.roll);
                setSecondPageValue(R.string.ride_time);
                setSecondPageValue(R.string.riding_time);
                setSecondPageValue(R.string.distance);
                setSecondPageValue(R.string.wheel_distance);
    ...
    private void updateScreen(boolean updateGraph) {
        ...
        switch (viewPagerPage) {
            ...
            case 1: // Text View
                ...
                if (use_mph) {
                    updateSecondPageValue(R.string.speed, String.format(Locale.US, "%.1f " + getString(R.string.mph), kmToMiles(WheelData.getInstance().getSpeedDouble())));
                    updateSecondPageValue(R.string.top_speed, String.format(Locale.US, "%.1f " + getString(R.string.mph), kmToMiles(WheelData.getInstance().getTopSpeedDouble())));
                    updateSecondPageValue(R.string.average_speed, String.format(Locale.US, "%.1f " + getString(R.string.mph), kmToMiles(WheelData.getInstance().getAverageSpeedDouble())));
                    updateSecondPageValue(R.string.average_riding_speed, String.format(Locale.US, "%.1f " + getString(R.string.mph), kmToMiles(WheelData.getInstance().getAverageRidingSpeedDouble())));
                    updateSecondPageValue(R.string.distance, String.format(Locale.US, "%.2f " + getString(R.string.milli), kmToMiles(WheelData.getInstance().getDistanceDouble())));
                    updateSecondPageValue(R.string.wheel_distance, String.format(Locale.US, "%.2f " + getString(R.string.milli), kmToMiles(WheelData.getInstance().getWheelDistanceDouble())));
                    updateSecondPageValue(R.string.user_distance, String.format(Locale.US, "%.2f " + getString(R.string.milli), kmToMiles(WheelData.getInstance().getUserDistanceDouble())));
                    updateSecondPageValue(R.string.total_distance, String.format(Locale.US, "%.2f " + getString(R.string.milli), kmToMiles(WheelData.getInstance().getTotalDistanceDouble())));
                } else {
                    updateSecondPageValue(R.string.speed, String.format(Locale.US, "%.1f " + getString(R.string.kmh), WheelData.getInstance().getSpeedDouble()));
                    updateSecondPageValue(R.string.top_speed, String.format(Locale.US, "%.1f " + getString(R.string.kmh), WheelData.getInstance().getTopSpeedDouble()));
                    updateSecondPageValue(R.string.average_speed, String.format(Locale.US, "%.1f " + getString(R.string.kmh), WheelData.getInstance().getAverageSpeedDouble()));
                    updateSecondPageValue(R.string.average_riding_speed, String.format(Locale.US, "%.1f " + getString(R.string.kmh), WheelData.getInstance().getAverageRidingSpeedDouble()));
                    updateSecondPageValue(R.string.distance, String.format(Locale.US, "%.3f " + getString(R.string.km), WheelData.getInstance().getDistanceDouble()));
                    updateSecondPageValue(R.string.wheel_distance, String.format(Locale.US, "%.3f " + getString(R.string.km), WheelData.getInstance().getWheelDistanceDouble()));
                    updateSecondPageValue(R.string.user_distance, String.format(Locale.US, "%.3f " + getString(R.string.km), WheelData.getInstance().getUserDistanceDouble()));
                    updateSecondPageValue(R.string.total_distance, String.format(Locale.US, "%.3f " + getString(R.string.km), WheelData.getInstance().getTotalDistanceDouble()));
                }

                updateSecondPageValue(R.string.voltage, String.format(Locale.US, "%.2f " + getString(R.string.volt), WheelData.getInstance().getVoltageDouble()));
                updateSecondPageValue(R.string.voltage_sag, String.format(Locale.US, "%.2f " + getString(R.string.volt), WheelData.getInstance().getVoltageSagDouble()));
                updateSecondPageValue(R.string.temperature, String.format(Locale.US, "%d°C", WheelData.getInstance().getTemperature()));
                updateSecondPageValue(R.string.temperature2, String.format(Locale.US, "%d°C", WheelData.getInstance().getTemperature2()));
                updateSecondPageValue(R.string.angle, String.format(Locale.US, "%.2f°", WheelData.getInstance().getAngle()));
                updateSecondPageValue(R.string.roll, String.format(Locale.US, "%.2f°", WheelData.getInstance().getRoll()));
                updateSecondPageValue(R.string.current, String.format(Locale.US, "%.2f " + getString(R.string.amp), WheelData.getInstance().getCurrentDouble()));
                updateSecondPageValue(R.string.power, String.format(Locale.US, "%.2f " + getString(R.string.watt), WheelData.getInstance().getPowerDouble()));
                updateSecondPageValue(R.string.battery, String.format(Locale.US, "%d%%", WheelData.getInstance().getBatteryLevel()));
                updateSecondPageValue(R.string.fan_status, WheelData.getInstance().getFanStatus() == 0 ? getString(R.string.off) : getString(R.string.on));
                updateSecondPageValue(R.string.charging_status, WheelData.getInstance().getChargingStatus() == 0 ? getString(R.string.discharging) : getString(R.string.charging));
                updateSecondPageValue(R.string.version, String.format(Locale.US, "%s", WheelData.getInstance().getVersion()));
                updateSecondPageValue(R.string.output, String.format(Locale.US, "%d%%", WheelData.getInstance().getOutput()));
                updateSecondPageValue(R.string.cpuload, String.format(Locale.US, "%d%%", WheelData.getInstance().getCpuLoad()));
                updateSecondPageValue(R.string.name, WheelData.getInstance().getName());
