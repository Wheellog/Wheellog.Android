...
public class KingsongAdapter extends BaseAdapter {
    ...
    private final KingSongFFFrameDecoder kingsongFFFrameDecoder;

    public KingsongAdapter(
            final WheelData wd,
            final AppConfig appConfig,
            final KingSongLiveDataDecoder kingsongLiveDataDecoder,
            final KingSongFFFrameDecoder kingsongFFFrameDecoder
    ) {
        this.wd = wd;
        this.appConfig = appConfig;
        this.kingsongLiveDataDecoder = kingsongLiveDataDecoder;
        this.kingsongFFFrameDecoder = kingsongFFFrameDecoder;
    }
