...
const val KINGSONG_DESCRIPTER_UUID = "00002902-0000-1000-8000-00805f9b34fb"
const val KINGSONG_READ_CHARACTER_UUID = "0000ffe1-0000-1000-8000-00805f9b34fb"
...
const val INMOTION_DESCRIPTER_UUID = "00002902-0000-1000-8000-00805f9b34fb"
const val INMOTION_READ_CHARACTER_UUID = "0000ffe4-0000-1000-8000-00805f9b34fb"
const val INMOTION_SERVICE_UUID = "0000ffe0-0000-1000-8000-00805f9b34fb"
const val INMOTION_WRITE_CHARACTER_UUID = "0000ffe9-0000-1000-8000-00805f9b34fb"
const val INMOTION_WRITE_SERVICE_UUID = "0000ffe5-0000-1000-8000-00805f9b34fb"
const val NINEBOT_Z_SERVICE_UUID = "6e400001-b5a3-f393-e0a9-e50e24dcca9e"
const val NINEBOT_Z_WRITE_CHARACTER_UUID = "6e400002-b5a3-f393-e0a9-e50e24dcca9e"
const val NINEBOT_Z_READ_CHARACTER_UUID = "6e400003-b5a3-f393-e0a9-e50e24dcca9e"
const val NINEBOT_Z_DESCRIPTER_UUID = "00002902-0000-1000-8000-00805f9b34fb"
const val INMOTION_V2_SERVICE_UUID = "6e400001-b5a3-f393-e0a9-e50e24dcca9e"
const val INMOTION_V2_WRITE_CHARACTER_UUID = "6e400002-b5a3-f393-e0a9-e50e24dcca9e"
const val INMOTION_V2_READ_CHARACTER_UUID = "6e400003-b5a3-f393-e0a9-e50e24dcca9e"
const val INMOTION_V2_DESCRIPTER_UUID = "00002902-0000-1000-8000-00805f9b34fb"
const val NINEBOT_SERVICE_UUID = "0000ffe0-0000-1000-8000-00805f9b34fb"
const val NINEBOT_WRITE_CHARACTER_UUID = "0000ffe1-0000-1000-8000-00805f9b34fb"
const val NINEBOT_READ_CHARACTER_UUID = "0000ffe1-0000-1000-8000-00805f9b34fb"
const val NINEBOT_DESCRIPTER_UUID = "00002902-0000-1000-8000-00805f9b34fb"
@JvmField
...
const val INTENT_EXTRA_GRAPH_UPDATE_AVILABLE = "graph_update_available"
...
const val INTENT_EXTRA_WHEEL_SETTINGS = "wheel_settings"
...
enum class ALARM_TYPE(val value: Int) {
    CURRENT(4), TEMPERATURE(5), PWM(6), SPEED1(1), SPEED2(2), SPEED3(3);
