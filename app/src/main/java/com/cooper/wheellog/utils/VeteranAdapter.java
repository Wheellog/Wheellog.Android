...
public class VeteranAdapter extends BaseAdapter {
    ...
    public boolean decode(byte[] data) {
        ...
        for (byte c : data) {
            if (unpacker.addChar(c)) {
                ...
                int veteranNegative = WheelLog.AppConfig.getVeteranNegative();
            ...
            if ((a1 == 0xDC) && (a2 == 0x5A) && (a3 == 0x5C) && (a4 == 0x20)) {  // Sherman
                ...
                if (data[5] >= 0)
                    if (veteranNegative == 0) {
                        ...
                        speed = ((int) (((data[4] * 256.0) + data[5]) * 3.6)) * veteranNegative;
                    }
                else if (veteranNegative == 0) {
                    speed = (int) Math.abs((((data[4] * 256.0) + 256.0) + data[5]) * 3.6);
                }
                else {
                    speed = ((int) ((((data[4] * 256.0) + 256.0) + data[5]) * 3.6)) * veteranNegative;
                }
                if (useRatio) {
                    speed = (int) Math.round(speed * RATIO_GW);
                }
                ...
                wd.setCurrent(veteranNegative == 0 ? Math.abs(wd.getCurrent()) : wd.getCurrent() * veteranNegative);
    ...
    public boolean isVeteran() { // todo: to remove
    ...
    static class veteranUnpacker {
        ...
        veteranUnpacker.UnpackerState state = UnpackerState.unknown;
