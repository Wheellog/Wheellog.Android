...
public class LoggingService extends Service
{
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (logLocationData) {
            ...
            if (logLocationData) {
                FileUtil.writeLine(filename, "date,time,latitude,longitude,location_distance,speed,voltage,current,power,battery_level,distance,totaldistance,temperature,temperature2,tilt,roll,mode,alert");
                ...
                FileUtil.writeLine(filename, "date,time,speed,voltage,current,power,battery_level,distance,totaldistance,temperature,temperature2,tilt,roll,mode,alert");
        }
        else
            FileUtil.writeLine(filename, "date,time,speed,voltage,current,power,battery_level,distance,temperature,temperature2,tilt,roll,mode,alert");
