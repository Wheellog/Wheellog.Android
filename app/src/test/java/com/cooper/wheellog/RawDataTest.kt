...
class RawDataTest {
    ...
    fun `GW - decode with normal data`() {
        ...
        val adapter =
            GotwayAdapter(config, data, GotwayUnpacker(), GotwayFrameADecoder(WheelData.getInstance(), GotwayScaledVoltageCalculator()), GotwayFrameBDecoder(WheelData.getInstance()))
